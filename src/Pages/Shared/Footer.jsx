      ...
      <footer className="bg-gray-200 p-10">
        ...
        <div className="mt-10 text-center">
          <div className="p-4 w-full text-center bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            ...
            <p className="lg:w-[50%] mx-auto mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">
              A person or company that produces finished goods from raw
              materials and sells the goods for the production of more complex
              goods.
            </p>
