    ...
    return (
      <div className="p-3 md:py-7 md:px-10">
        <div className="text-center">
          <h2 className="uppercase md:mb-3 font-bold text-[20px] md:text-5xl text-[#2BAAA9]">
            Millions Business Trust Us
          </h2>
          <span className="uppercase text-[#00033E] text-sm md:text-[20px] font-semibold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-items-center gap-4 py-4 md:py-16">
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="text-2xl font-semibold text-[#2BAAA9]">
              Countries
            </div>
          </div>
          <div className="flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:px-10 md:py-12">
          <div className="flex-1">
            <h2 className="text-xl md:text-3xl text-[#2BAAA9] font-semibold">
              Have any question about us or get a products request ?
            </h2>
            <h3 className="text-md md:text-[20px]">
          ...
          <div className="flex-1 flex justify-center space-x-2 mt-2 md:space-x-3 text-center">
            <Link
              to="/"
              className="btn bg-[#2BAAA9] hover:bg-[#0f8686] border-none"
            >
              Request For Quote
            </Link>
            <Link
              to="/"
              className="btn bg-[#00033E] hover:bg-[#0c0e34] border-none"
            >
              Contact Us
            </Link>
          </div>
